...
public class Student {
    ...
    void printNote()
    {
    	System.out.println(this.c1.name + " Yazýlý Notu : " + this.c1.note + " Sözlü Notu : " + this.c1.opNote);
    	System.out.println(this.c2.name + " Yazýlý Notu : " + this.c2.note + " Sözlü Notu : " + this.c2.opNote);
    	System.out.println(this.c3.name + " Yazýlý Notu : " + this.c3.note + " Sözlü Notu : " + this.c3.opNote);
